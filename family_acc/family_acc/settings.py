"""
Django settings for family_acc project.
...
WSGI_APPLICATION = 'family_acc.wsgi.application'
...
# STATIC_ROOT is only for production
...
# EMAIL_HOST_PASSWORD = secrets.APPPASSWORD
